...
def main():
    ...
    day_message_dict = {
        ...
        '8,18,28': {'17:30': ['电信APP-四川服务-精选月月选权益', ], 
             '18:00': []},
        '1,11,21':{'09:50':['招商银行APP-会员-领取黄金（10点）',],
        },
        '1': {'17:30': ['云闪付APP-会员权益-信用卡还款', '电信APP-四川服务-领取流量','支付宝积分兑换话费券-用电信APP充值-选择支付宝支付'],
        ...
        #用于每月最后几天，检查是否有任务未执行
        '27':{'18:00':['中国移动-铂金会员是否领取完毕','平安口袋银行-积分是否过期','微信小程序,乐惠畅玩-券是否已全部使用'],
    ...
    # 预定义星期几对应的时间和输出文本
    week_message_dict = {
        'Monday': {'09:40': ['检查云闪付-有礼乐开花！','成都农商银行-新春周周礼'],
                   },
        'Tuesday': {'08:00': ['微信小程序-京东有礼-E卡-云闪付5减1'],
                    '18:00': []},
        'Wednesday': {'09:50': ['和包APP-领取金融券','中国移动云盘-活动中心-惊喜福利（微信立减金）'],
                      },
        'Thursday': {'09:55': ['平安银行-周四开盲盒',],
                     '19:00': ['微信永辉超市群-口令兑换无门槛券',],
                     },
        'Friday': {'09:50': ['中国移动APP-权益-周五喝一杯（十点）','12580惠生活-红旗券是否使用完毕'],
                   },
        'Saturday': {'09:45': ['10点-邮政工会信用卡-200减40油卡'],
                     '07:00': ['微信小程序-京东有礼-E卡-云闪付5减1',]},
        'Sunday': {'18:00': ['检查-支付有优惠金币'],
                   }
    }
